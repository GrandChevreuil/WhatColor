    ...
    Column(
        ...
        Row(
            ...
            Column(
                ...
                WelcomeButton(
                    text = stringResource(id = R.string.play_game_ls_button),
                    onClick = playGameClick
                )
                WelcomeButton(
                    text = stringResource(id = R.string.show_global_scores_ls_button),
                    onClick = {},
                    enabled = false
                )
            }
...
fun WelcomeScreenPreview() {
    // Create a fake GameUiState for preview
    val fakeUiState = GameUiState(lastScore = 5, localHighScore = 10)
    WelcomeScores(gameUiState = fakeUiState)
}
